 ...
 *
 * @package VW_School_Education
 */

if ( ! class_exists( 'VW_School_Education_Content_Creation' ) ) :

	/**
	 * VW_School_Education_Content_Creation class.
	 */
	class VW_School_Education_Content_Creation extends WP_Customize_Control {
		...
		/**
		 * VW_School_Education_Content_Creation constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'VW_School_Education_Content_Creation' );
